...
settings = struct('d_sub',2000,'L',500,'seed_subspaces',5,'seed_bootstrap',73);
[~,results] = ensemble_training(TRN_cover,TRN_stego,settings);

% You can fully suppress the ensemble output by setting 'verbose' to 0:
settings = struct('d_sub',2000,'L',500,'verbose',0);
[~,results] = ensemble_training(TRN_cover,TRN_stego,settings);
...
settings = struct('d_sub',2000,'L',500,'verbose',2);
[~,results] = ensemble_training(TRN_cover,TRN_stego,settings);
...
settings = struct('d_sub',2000,'verbose',2);
for seed = 1:10
